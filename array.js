...
const advices = [
    ...
    {
        quotee: 'Prophet Muhammad (Peace Be Upon Him)',
        quote: 'The greatest Jihad is to battle your own soul, to fight the evil within yourself.'
    },
    {
        quotee: 'Prophet Muhammad (Peace Be Upon Him)',
        quote: 'He is not a believer whose stomach is filled while his neighbour goes hungry.'
    },
    {
        quotee: 'Prophet Muhammad (Peace Be Upon Him)',
        quote: 'A strong man is not the one good wrestler, a strong man is only the one who controls himself when he is angry.'
    },
    {
        quotee: 'Prophet Muhammad (Peace Be Upon Him)',
        quote: 'A good man treats women with honour.'
    },
    //4 Caliphs Al-Rashidun
    {
        quotee: 'Sayyidina Abu Bakr As-Siddiq (Radhiyallahu ‘anhu)',
    ...
    {
        quotee: 'Hazrat Umar Ibn Al-Khattab (Radhiyallahu ‘anhu)',
    ...
    {
        quotee: 'Hazrat Umar Ibn Al-Khattab (Radhiyallahu ‘anhu)',
        quote: 'Whosoever shows you your faults is your friend. Those that pay you lip service in praise are your executioners.'
    },
    {
        quotee: 'Hazrat Umar Ibn Al-Khattab (Radhiyallahu ‘anhu)',
    ...
    {
        quotee: 'Sayyidina Uthman Al Affan (Radhiyallahu ‘anhu)',
        quote: 'Worrying about the dunya is a darkness in the heart, while worrying about akhirah is a light in the heart.'
    },
    {
        quotee: 'Sayyidina Uthman Al Affan (Radhiyallahu ‘anhu)',
        quote: 'A backbiter harms three persons, firstly himself, secondly the persom whom he is addressing and thirdly the person whom he is backbiting.'
    },
    {
        quotee: 'Sayyidina Uthman Al Affan (Radhiyallahu ‘anhu)',
        quote: `If the hearts are pure, they will never have enough from reciting Allah's words (the Qur'an).`
    },
    {
        quotee: 'Sayyidina Uthman Al Affan (Radhiyallahu ‘anhu)',
        quote: `Your charity is not accepted until you believe: "I need the reward more than the beggar needs the money".`
    },
    {
        quotee: 'Sayyidina Uthman Al Affan (Radhiyallahu ‘anhu)',
    ...
    {
        quotee: 'Imam Ali Ibn Abi Talib (Radhiyallahu ‘anhu)',
        quote: 'If poverty were a man, I would have slain him.'
    },
    {
        quotee: 'Imam Ali Ibn Abi Talib (Radhiyallahu ‘anhu)',
        quote: 'Knowledge is a venerable estate, good manners are new dresses, and thinking is a clear mirror.'
    },
    {
        quotee: 'Imam Ali Ibn Abi Talib (Radhiyallahu ‘anhu)',
    ...
    {
        quotee: 'Imam Ali Ibn Abi Talib (Radhiyallahu ‘anhu)',
        quote: 'Patience is of 2 kinds: enduring what you hate & abstaining from what you love.'
    },
    {
        quotee: 'Imam Ali Ibn Abi Talib (Radhiyallahu ‘anhu)',
        quote: "Be like the flower that gives it's fragrance even to the hand that crushes it."
    }
]
...
[
        ...
        {
            quote: 'When you are three persons, then two of you should not whisper excluding the third person, for that would grieve him.',
            quotee: 'Prophet Muhammad (peace be upon him)'
        },
        {
